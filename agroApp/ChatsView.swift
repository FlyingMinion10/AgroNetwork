...
struct ChatsView: View {
    ...
    func fetchChats() {
        guard let baseUrl = URL(string: "myServerURLchats/get") else {
            print("URL no válida")
            return
        }
...
struct ChatView: View {
    ...
    // MARK: - Func Get Mply
    func fetchMonopoly() {
        guard let baseUrl = URL(string: "myServerURLmonopoly/get") else {
            print("URL no válida")
            return
        }
...
//            }
    ...
    // MARK: - Func Get Msj
    func fetchMessages() {
        guard let baseUrl = URL(string: "myServerURLmessages/get") else {
            print("URL no válida")
            return
        }
    ...
    func acceptDeal() {
        guard let url = URL(string: "myServerURLmonopoly/accept") else { return }
        var request = URLRequest(url: url)
...
//                }
    ...
    // MARK: - Func Edit Mply
    func editMonopoly() {
        guard let url = URL(string: "myServerURLmonopoly/edit") else { return }
        var request = URLRequest(url: url)
        request.httpMethod = "POST"
        request.setValue("application/json", forHTTPHeaderField: "Content-Type")
...
//              Aquí puedes manejar la respuesta del servidor
    ...
    // MARK: - Func Send Msj
    func sendMessage() {
        guard let url = URL(string: "myServerURLmessages/send") else { return }
        var request = URLRequest(url: url)
        request.httpMethod = "POST"
        request.setValue("application/json", forHTTPHeaderField: "Content-Type")
